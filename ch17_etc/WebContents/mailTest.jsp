...
<%
	...
	p.put("mail.smtp.starttls.enable","true");  //stmp서버 주소
	...
	try{
		...
		from = new InternetAddress("thgus0426@naver.com"); //발신자 아이디
		msg.setFrom(from); //이메일 발신자
		InternetAddress to = new InternetAddress("thgus0426@naver.com"); //수신자
